...
> Следующий курс: v0.25 = шаги **7a → 7b → 7c → 7d** (Due date, §шаг 7 живого плана) + **8** (Сегодня/спринты).
> Фоновые наблюдения по этой версии: **B-1** (март-метрики confirmed, 2–4 нед), **B-2** (правило авто-подтверждения, только по данным B-1).
