...
**Текущий шаг:** **шаг 6 (Персоны) — РЕЖИМ A** (решения владельца ЗАФИКСИРОВАНЫ 2026-09-15, режим B завершён; код ещё не начат).
...
### [ ] Шаг 6 — Персоны: справочник + assignee на персонах + авто-назначение (v0.24)
**Статус: РЕШЕНИЯ ЗАФИКСИРОВАНЫ (2026-09-15, режим B завершён) → РЕЖИМ A.**
